    ...
    <form action="" method="post">
        <table>
            <tr>
                ...
                <td> <?php if (isset($_POST['Entrar']) && empty($_POST['usuario'])) echo "<span style='color:red'> Debes introducir el usuario</span>" ?> </td>
            </tr>
            <tr>
                <td> Constraseña: </td>
                <td><input type="password" name="contrasena" value = "<?php if (isset($_POST['contrasena'])) echo $_POST['contrasena']; ?>"/></td>
                <td><?php if (isset($_POST['Entrar']) && empty($_POST['contrasena'])) echo "<span style='color:red'> Debes introducir una contraseña</span>" ?></td>
            </tr>
        </table>
